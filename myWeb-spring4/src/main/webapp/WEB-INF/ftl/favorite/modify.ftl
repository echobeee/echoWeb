...
<div id="particles-js">
    ...
    <div class="container" style="position: absolute; top:115px; left:355px;">
		<h1 style="margin-bottom: 20px;left: 200px;position: relative;">添加收藏夾</h1>
       <form class="form-horizontal" role="form" action="${request.contextPath}/favorites/addWebsite.do" method="post">
     	 <input type="hidden" id="userId" value="${user.userId}" /> 
         <div class="form-group form row">
		    <label for="firstname" class="col-sm-2 control-label">網站別名：</label>
		    <div class="col-sm-3">
		      <input type="text"  class="form-control col-lg-3" id="webSiteName" name="webSiteName" >
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="lastname" class="col-sm-2 control-label">網站地址：</label>
		    <div class="col-sm-3">
		      <input type="text" class="form-control col-lg-3" id="webSiteUrl" name="webSiteUrl">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		   <div class="col-sm-offset-2">
			    <div class="col-sm-9" style="width: 13%;">
			      <button type="button" id="submitButton" class="form-control btn btn-info pull-right">确认</button>
			    </div>
		    </div>
		  </div>
